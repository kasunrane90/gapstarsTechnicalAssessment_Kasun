...
describe('PostHandler.vue', () => {
    ...
    describe("Posts.vue", () => {
        ...
        it("Up button => post should move to one index up when the position of the post is not 0th index in the array list and an entry should be added to postHistory arrays", () => {
        ...
        it("Down button => post should move to one index down when the position of the post is not at 4th index(last) in the array list and an entry should be added to postHistory arrays", () => {
